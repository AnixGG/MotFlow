...
def summarize_timing(
    ...
    return {
        ...
        "wall_latency_ms_std": round(_std(wall_latencies_ms), 4),
        ...
        "preprocess_latency_ms_std": round(_std(preprocess_latencies_ms), 4),
        ...
        "inference_latency_ms_std": round(_std(inference_latencies_ms), 4),
        ...
        "postprocess_latency_ms_std": round(_std(postprocess_latencies_ms), 4),
        ...
        "model_latency_ms_std": round(_std(model_latencies_ms), 4),
        ...
        "residual_latency_ms_std": round(_std(residual_latencies_ms), 4),
        ...
        "raft_gmc_latency_ms_std": round(_std(raft_gmc_latencies_ms), 4),
...
def build_overall_timing_row(
    ...
    return {
        ...
        "wall_latency_ms_std": round(_std(all_wall_latencies), 4),
        ...
        "preprocess_latency_ms_std": round(_std(all_preprocess_latencies), 4),
        ...
        "inference_latency_ms_std": round(_std(all_inference_latencies), 4),
        ...
        "postprocess_latency_ms_std": round(_std(all_postprocess_latencies), 4),
        ...
        "model_latency_ms_std": round(_std(all_model_latencies), 4),
        ...
        "residual_latency_ms_std": round(_std(all_residual_latencies), 4),
        ...
        "raft_gmc_latency_ms_std": round(_std(all_raft_gmc_latencies), 4),
